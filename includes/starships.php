<?php 
  class Starships {
    ...
    public function __construct($name,$model,$manufacturer,$length,$max_speed,$crew,$passengers,$capacity,$movies){
      $this->name = $name;
      $this->model = $model;
...
if(isset($_GET['url'])){
  ...
  $starships = new Starships($var_name,$var_model,$var_manufacturer,$var_length,$var_max_atmosphering_speed,$var_crew,$var_passengers,$var_capacity,$var_movies);
